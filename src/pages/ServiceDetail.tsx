...
export default function ServiceDetail() {
  ...
  if (!service) return <div className="pt-24 text-center text-gray-500">Service not found. <Link to="/" className="text-brand-accent underline">Go back</Link></div>
      ...
      <section className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href={business.telLink}
            className="bg-brand-accent text-white font-oswald text-lg px-8 py-4 rounded-lg hover:bg-yellow-500 transition text-center">
            📞 Call Jeff — {business.phone}
          </a>
          <a href="/#book"
            className="border-2 border-brand-primary text-brand-primary font-oswald text-lg px-8 py-4 rounded-lg hover:bg-brand-primary hover:text-white transition text-center">
